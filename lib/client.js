...
var Client = function(socket){
  ...
  //afterstore must contain `live`
  //beforestore must contain copies
...
Client.prototype.put = function(resource, callback){ 
  ...
  self.AfterStore.put(resource);
  self.BeforeStore.applyChangeset(changeset);
  self._maintainLists(changeset);
  return resource;
};
